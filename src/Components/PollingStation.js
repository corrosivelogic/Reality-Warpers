...
const PollingStation = (props) => {
  const [candidate1URL, changeCandidate1Url] = useState(Group1);
  const [candidate2URL, changeCandidate2Url] = useState(Group1);
    ...
    <Container>
      <Row>
        ...
        <Col className='justify-content-center d-flex align-items-center'>
          ...
          >*Click on the vote button under the candidate you wish to vote*
            {prompt}
          </div>
        </Col>
        <Col className='jutify-content-center d-flex'>
